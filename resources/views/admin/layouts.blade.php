            ...
            <!-- menu profile quick info -->
                ...
                <div class="profile clearfix">
                    ...
                    <div class="profile_info">
                        <span>Welcome,</span>
                        @auth
                        <!-- Display User's Full Name Here -->
                        <h2>{{ Auth::users()->name }}</h2>
                        @endauth
                    </div>
                </div>
            <!-- /menu profile quick info -->
                    ...
                    <li><a href="{{route('admin.users.create')}}">Add User</a></li>
							...
							<li><a><i class="fa fa-desktop"></i> Beverages<span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="{{route('beverages.create')}}">Add Beverages</a></li>
									</ul>
								</li>
                <li><a><i class="fa fa-desktop"></i> Massage<span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{route('all-messages')}}">Massage List</a></li>
										li>
									</ul>
								</li>
                ...
                <ul class=" navbar-right">
                  ...
                  <li role="presentation" class="nav-item dropdown open">
                    ...
                    <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                      <?php $unreadCount = app(\App\Http\Controllers\ContactController::class)->unreadMessagesCount(); ?>
                      @isset($messages)
                      ...
                      <li class="nav-item">
                          <div class="text-center">
                              <a class="dropdown-item" href="{{ route('all-messages') }}">
                                  <a href="{{ route('all-messages') }}">
                                      Unread Messages <span class="badge">{{ $unreadCount }}</span>
                                  </a>
