						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								{{-- <li><a><i class="fa fa-edit"></i> Tags <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{route('addCategory.html')}}">Add Tag</a></li>
										<li><a href="{{route('categories.html')}}">Tags List</a></li>
									</ul>
								</li>
								<li><a><i class="fa fa-desktop"></i> Photos <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{route('addPhoto.html')}}">Add Photo</a></li>
										<li><a href="{{route('photos.html')}}">Photos List</a></li>
									</ul>
								</li> --}}
                <li><a><i class="fa fa-users"></i> Customers <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                      <li><a href="{{route('cust')}}">Customers List</a></li>
                      <li><a href="{{route('customerCreate')}}">Add Customers</a></li>
                  </ul>
              </li>
              <li><a><i class="fa fa-users"></i> Posts <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
